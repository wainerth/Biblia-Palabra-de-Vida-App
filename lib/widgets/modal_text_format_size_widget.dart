...
class _ModalTextFormatSizeWidgetState extends State<ModalTextFormatSizeWidget> {
  ...
  Widget build(BuildContext context) {
    // Usar Consumer para que la modal se reconstruya cuando cambie el tema
                          ...
                          child: ListView(
                            ...
                            children: [
                              ...
                              ...BibleThemeType.values.map((theme) {
                                ...
                                // Ahora obtenemos el estado actual del tema desde el provider
                                final isSelected =
                              ...
                              ...themeProvider.customThemes.map((customTheme) {
                                final isSelected = themeProvider.isCustomTheme &&
                                    themeProvider.currentCustomTheme?.id ==
                                        customTheme.id;
              
                                return GestureDetector(
                                  onTap: () =>
                                      themeProvider.applyCustomTheme(customTheme),
                                  child: Stack(
