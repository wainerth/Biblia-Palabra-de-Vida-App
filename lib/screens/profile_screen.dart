...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final cardList = [
      ...
      {'label': 'Aventura', 'img': '/aventura.png'},
      {'label': 'La Biblia', 'img': '/biblia.png'},
      {'label': 'Comunidad', 'img': '/comunidad.png'},
    ];
  ...
  _buildStoriesSection(BuildContext context) {
    return Column(
      ...
      children: [
        Text("Cuentos para reflexionar", style: StylesApp(context).textStyleBody5.copyWith(color: Color(0xFFFE8D43)),),
